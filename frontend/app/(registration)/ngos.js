...
import NgoBrowseDirectory from "../components/NgoBrowseDirectory";
import NgoRegistrationForm from "../components/NgoForm";
...
export default function NgosScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {activeTab === "browse" && <NgoBrowseDirectory />}

      {/* OPTION 2: NGO REGISTRATION FORM */}
      {activeTab === "register" && <NgoRegistrationForm />}
    </SafeAreaView>
  );
}
