...
import AmbulanceBrowseDirectory from "../components/BrowseDirectoryUI";
import AmbulanceRegistrationForm from "../components/AmbulanceForm";
...
export default function AmbulancesScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {activeTab === "browse" && <AmbulanceBrowseDirectory />}

      {/* OPTION 2: AMBULANCE REGISTRATION FORM */}
      {activeTab === "register" && <AmbulanceRegistrationForm />}
    </SafeAreaView>
  );
}
